...
const userSchema = new mongoose.Schema(
  {
    ...
    email: {
      ...
      trim: true,
      lowercase: true,
      // Fixed: property should be 'validate', not 'validator'
...
/**
 * REFACTORED: Removed 'next' because the function is async.
 * Modern Mongoose handles the completion automatically when the promise resolves.
 */
